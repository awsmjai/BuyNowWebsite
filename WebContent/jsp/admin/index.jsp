				...
				<div class="navbar-default sidebar" role="navigation">
					<div class="sidebar-nav navbar-collapse">
						<ul class="nav" id="side-menu">
							...
							<li><a href="addProduct.jsp" class=" hvr-bounce-to-right"><i
									class="fa fa-plus-circle nav_icon"></i> <span class="nav-label">Add
										Product</span></a> <!-- <ul class="nav nav-second-level">
						...
						<li><a href="typography.html" class=" hvr-bounce-to-right"><i class="fa fa-file-text-o nav_icon"></i>Typography</a></li>
							...
							<li><a href="searchProduct.jsp" class=" hvr-bounce-to-right">
							<i class="fa fa-search nav_icon" ></i> <span class="nav-label">Search Product</span> </a></li>
	...
	<div id="page-wrapper" class="gray-bg dashbard-1">
		<div class="content-main">
			...
			<div class="banner">
				...
				<%String result= (String)request.getAttribute("deleteResult");%>
					<%if(result==null)
					    {
					...
					<tbody class="table-hover">
						...
						<tr>
							...
							<td class="text-left"><img
								...
								src="../../product/<%=product.getProductImageName()%>" alt="">
							</td>
							...
							<td class="text-left">
							   <a href="getProductId?id=<%=product.getProductId()%>">
							   <i class="fa fa-pencil" aria-hidden="true"></i></a>
							</td>

							<td class="text-left">
							<a href="deleteProduct?id=<%=product.getProductId()%>">
